/* autogenerated by Processing revision 1293 on 2026-01-27 */
...
public boolean matchesField(String part, String name) {
  String lower = part.toLowerCase();
  return lower.startsWith(name + ":") || lower.startsWith(name + "=");
}

public String valueOfField(String part) {
