/* autogenerated by Processing revision 1293 on 2026-01-11 */
...
public class AttitudeIndicator extends PApplet {
...
public void draw() {
  ...
  float pixelsPerDegree = (diam * 0.8f) / 180.0f;
...
public void parseCommand(String cmd) {
  ...
  for (String part : parts) {
    if (part.startsWith("pitch:")) {
      pitch = PApplet.parseFloat(part.substring(6));
    } else if (part.startsWith("roll:")) {
      roll = radians(PApplet.parseFloat(part.substring(5)));
    } else if (part.startsWith("p:")) {
      pitch = PApplet.parseFloat(part.substring(2));
    } else if (part.startsWith("r:")) {
      roll = radians(PApplet.parseFloat(part.substring(2)));
    }
  }
}
...
public void keyPressed() {
  if (keyCode == LEFT)  rollSpeed = -0.06f;
  if (keyCode == RIGHT) rollSpeed = 0.06f;
  if (keyCode == UP)    pitchSpeed = -1.5f;
  if (keyCode == DOWN)  pitchSpeed = 1.5f;
}
...
smooth(); }
  ...
  static public void main(String[] passedArgs) {
    String[] appletArgs = new String[] { "AttitudeIndicator" };
    if (passedArgs != null) {
